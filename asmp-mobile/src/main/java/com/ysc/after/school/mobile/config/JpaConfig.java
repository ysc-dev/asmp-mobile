...
@EnableJpaRepositories(transactionManagerRef = "txManager", basePackageClasses = { SchoolRepository.class })
public class JpaConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		factoryBean.setPackagesToScan(School.class.getPackage().toString().substring(8));
